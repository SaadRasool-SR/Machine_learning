...
Once the envirnoment is set up, it is important to note that there are four different python script that will be required to run inorder to generate and train all of the 5 algorithms.

The four scripts are:
1) assignment_1_ANN.py (neural network)
2) assignment_1_DT.py (Decision Tree / Boosted Decision Tree)
3) assignment_1_KNN.py (K-nearest neighbor)
4) assignment_1_SVM.py (support machine vector)
...
1) assignment_1_ANN.py (neural network): 30 - 32 
2) assignment_1_DT.py (Decision Tree / Boosted Decision Tree): 21 - 23
3) assignment_1_KNN.py (K-nearest neighbor): 18 - 20 
4) assignment_1_SVM.py (support machine vector) : 23 - 25
